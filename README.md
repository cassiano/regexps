# This toy, personal project, uses Parser Combinators and a NFA (Non-deterministic Finite Automatum) to parse and evaluate regular expressions against a given string.
